...
{
    Bytes raw = ""_str_bytes;
    Bytes expected = "9d14aaae0326c678a486c74763ec6cd3"_hex_bytes;
...
{
    Bytes raw = "1"_str_bytes;
    Bytes expected = "C742DD0F19ABAE9D3C79FB3784F4420F"_hex_bytes;
    Bytes key = "long time no see"_str_bytes;
    Bytes iv = "abcdefghijklmnop"_str_bytes;
    auto aes_cbc = CbcMode<AES>::Encrypter(iv.data(), key);
...
{
    Bytes raw = "vvwqeasdcveehytj"_str_bytes;
    Bytes expected = "48931E91F44D04F875E7319E058D40C54982CC3BB23AB40A57506582E2AB977E"_hex_bytes;
    Bytes key = "long time no see"_str_bytes;
    Bytes iv = "abcdefghijklmnop"_str_bytes;
    auto aes_cbc = CbcMode<AES>::Encrypter(iv.data(), key);
...
TEST(aes_128_cbc_encrypt, long_one_time)
{
    ...
    Bytes key = "long time no see"_str_bytes;
    Bytes iv = "abcdefghijklmnop"_str_bytes;
    CbcMode<AES>::Encrypter derived(iv.data(), key);
